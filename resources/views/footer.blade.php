     ...
     <footer>
      <div class="footer">
        <div class="main-content">
          <div class="row">
            ...
            <div class="colum">
              ...
              <div class="socials">
                <a href="!#"
                  ><img
                    src="CSS/icon/Twitter.svg"
                    alt="Twitter"
                    class="icon"
                /></a>
                <a href="https://www.facebook.com/"
                  ><img src="CSS/icon/f.svg" alt="facebook" class="icon"
                /></a>
                <a href="!#"
                  ><img
                    src="CSS/icon/linked_in.svg"
                    alt="linked_in"
                    class="icon"
                /></a>
                <a href="!#"
          ...
          <p class="underlaign"></p>
          <p class="descriptionlv2">Copyright ©2022 webdesign.gdn All rights reserved</p>
        </div>
      </div>
    </footer>
</body>
